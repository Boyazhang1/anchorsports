...
const Footer = () => {
  return (
    <footer className="text-gray-600 body-font">
      <div className="container sm:px-2 py-12 mx-auto">
        ...
        <nav className="list-none mb-10">
          ...
          <div className="md:w-1/2 w-full md:px-4 self-end inline-block">
            <h2 className="title-font font-medium text-gray-900 tracking-widest text-sm mb-3">
              SUBSCRIBE
            </h2>
            <div className="flex flex-nowrap justify-center md:justify-start items-end ">
              <div className="relative w-[55%] sm:w-auto sm:mr-4 mr-2">
      ...
      <div className="bg-gray-100">
        <div className="container px-5 py-6 mx-auto flex items-center sm:flex-row flex-col">
          <a className="flex title-font font-medium items-center md:justify-start justify-center text-gray-900">
            ...
            <span className="ml-3 text-xl">Anchor Sports</span>
          </a>
